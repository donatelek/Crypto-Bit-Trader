    ...
    render() {
        return (
            <div className="technicalAnalysisWidget">
                {!this.props.lockedDraggable && <><div className="drag" onMouseDown={() => this.props.handleDisplayBlur('techAnalysisBlur')} onMouseUp={() => this.props.handleRemoveBlur('techAnalysisBlur')} ></div></>}
