    ...
    render() {
        return (
            <div className="marketDataWidget">
                {!this.props.lockedDraggable && <><div className="drag" onMouseDown={() => this.props.handleDisplayBlur('marketDataBlur')} onMouseUp={() => this.props.handleRemoveBlur('marketDataBlur')} ></div></>}
