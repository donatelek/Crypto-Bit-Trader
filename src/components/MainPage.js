      ...
      <main>
        <section class="hero">
          <div class="container">
            <div class="hero-inner">
              <div class="hero-copy">
                <Fade>
                  <h1 class="hero-title mt-0 is-revealing14" ref='huh'>CRYPTO BIT-TRADER</h1>
                  <p class="hero-paragraph is-revealing15">All in one tool for cryptocurrency traders
                  </p>
                  <div class="hero-cta is-revealing16" ><Link to='/register' class="button button-primary" href="#">Getting Started</Link></div>
                </Fade>
              </div>
              <Fade>
                <div class="hero-figure anime-element is-revealing17" >
                  <img src={banner} alt="" />
                </div>
              </Fade>
            </div>
          ...
          <div class="container">
            ...
            <div class="features-inner section-inner has-bottom-divider">
              <div class="features-wrap">
                <div class="feature text-center is-revealing1">
                  <Fade>
                ...
                <div class="feature text-center is-revealing2">
                  <Fade>
                    <div class="feature-inner">
                      <div class="feature-icon">
                ...
                <div class="feature text-center is-revealing3">
                  <Fade>
                    <div class="feature-inner">
        ...
        <section class="features section">
          ...
          <div class="container">
            <div class="features-inner section-inner has-bottom-divider">
              <div class="features-wrap">
                <div class="feature text-center is-revealing4">
                  <Fade>
                    <div class="feature-inner">
                      <div class="feature-icon">
                ...
                <div class="feature text-center is-revealing5">
                  <Fade>
                    <div class="feature-inner">
                      <div class="feature-icon">
                ...
                <div class="feature text-center is-revealing6">
                  <Fade>
                    <div class="feature-inner">
                      <div class="feature-icon">
                ...
                <div class="feature text-center is-revealing7">
                  <Fade>
                    <div class="feature-inner">
                      <div class="feature-icon">
                ...
                <div class="feature text-center is-revealing8">
                  <Fade>
                    <div class="feature-inner">
                      <div class="feature-icon">
                ...
                <div class="feature text-center is-revealing9">
                  <Fade>
                    <div class="feature-inner">
                      <div class="feature-icon">
            ...
            <div class="pricing-inner section-inner">
              ...
              <div class="pricing-tables-wrap">
                <div class="pricing-table">
                  <div class="pricing-table-inner is-revealing10">
        ...
        <section class="features section">
          ...
          <div class="container">
            <div class="features-inner section-inner has-bottom-divider">
              <div class="features-wrap">
                <div class="feature text-center is-revealing11">
                  <Fade>
                    <div class="feature-inner ">
                ...
                <div class="feature text-center is-revealing12">
                  <Fade>
                    <div class="feature-inner">
                      <div class="feature-icon feedback-icon">
                ...
                <div class="feature text-center is-revealing13">
                  <Fade>
                    <div class="feature-inner">
                      <div class="feature-icon feedback-icon">
